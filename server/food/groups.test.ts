...
describe('classify', () => {
  ...
  it('couvre tous les sous-groupes de l’export 2020', () => {
    // Les codes réellement portés par les 3 185 aliments de l'export.
    const used = [
      '0101','0102','0103','0104','0105','0106','0201','0202','0203','0204','0205',
      '0301','0302','0303','0305','0401','0402','0403','0404','0405','0406','0407',
      '0408','0409','0410','0411','0501','0502','0503','0504','0601','0602','0603',
      '0701','0702','0703','0704','0705','0706','0707','0708','0709','0801','0802',
      '0803','0901','0902','0903','0904','0905','1001','1002','1003','1004','1005',
      '1006','1007','1008','1009','1101','1102','1103','1104','0000',
    ];
    const missing = used.filter((code) => !isKnownSubgroup(code));
    assert.deepEqual(missing, [], `sous-groupes non classés : ${missing.join(', ')}`);
    assert.equal(knownSubgroups().length, used.length);
  });
});
